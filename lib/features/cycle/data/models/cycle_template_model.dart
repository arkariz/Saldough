...
final class CycleTemplateModel {
  ...
  factory CycleTemplateModel.fromJson(Map<String, dynamic> json) => CycleTemplateModel(
  ...
  factory CycleTemplateModel.fromEntity(CycleTemplate template) => CycleTemplateModel(
        ...
        defaultAllocations: template.defaultAllocations.map(AllocationModel.fromEntity).toList(),
      );
