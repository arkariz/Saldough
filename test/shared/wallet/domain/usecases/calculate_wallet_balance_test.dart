...
void main() {
  ...
  group('CalculateWalletBalance', () {
    ...
    test('saldo awal 5.000.000, masuk 2.615.438, keluar 3.068.500, transfer keluar 1.000.000 menghasilkan 3.546.938', () {
      final transactions = [
    ...
    test('transaksi milik dompet lain diabaikan', () {
      final other = ExpenseTransaction(id: 't1', date: DateTime(2026, 9), amount: 50000, note: 'kopi', walletId: 'gopay');
    ...
    test('saldo boleh negatif', () {
      ...
      final expense = ExpenseTransaction(id: 't1', date: DateTime(2026, 9), amount: 150000, note: 'tagihan', walletId: 'w1');
